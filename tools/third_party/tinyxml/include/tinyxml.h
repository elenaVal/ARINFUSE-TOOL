...
public:
	...
	*/
	...
	const TiXmlNode* FirstChild( const char * value, bool anyCasing = false ) const;			///< The first child of this node with the matching 'value'. Will be null if none found.
	TiXmlNode* FirstChild(const char * value, bool anyCasing = false);						///< The first child of this node with the matching 'value'. Will be null if none found.
	...
	*/
	...
	template <class T>
	T* MaybeCastToMoreDefinedType(NodeType expected_type) const {
		if (type == expected_type) {
			// TODO(yannic): Use static_cast.
			return (T*)this;
		}
	  return nullptr;
	}
	...
	TiXmlDocument* ToDocument()	{
		return MaybeCastToMoreDefinedType<TiXmlDocument>(DOCUMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlDocument* ToDocument()	const {
		return MaybeCastToMoreDefinedType<const TiXmlDocument>(DOCUMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlElement* ToElement() {
		return MaybeCastToMoreDefinedType<TiXmlElement>(ELEMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlElement* ToElement() const {
		return MaybeCastToMoreDefinedType<const TiXmlElement>(ELEMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlComment* ToComment() {
		return MaybeCastToMoreDefinedType<TiXmlComment>(COMMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlComment* ToComment() const {
		return MaybeCastToMoreDefinedType<const TiXmlComment>(COMMENT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlUnknown* ToUnknown() {
		return MaybeCastToMoreDefinedType<TiXmlUnknown>(UNKNOWN);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlUnknown* ToUnknown() const {
		return MaybeCastToMoreDefinedType<const TiXmlUnknown>(UNKNOWN);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlText* ToText() {
		return MaybeCastToMoreDefinedType<TiXmlText>(TEXT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlText* ToText() const {
		return MaybeCastToMoreDefinedType<const TiXmlText>(TEXT);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	TiXmlDeclaration* ToDeclaration() {
		return MaybeCastToMoreDefinedType<TiXmlDeclaration>(DECLARATION);
	}

	///< Cast to a more defined type. Will return null not of the requested type.
	const TiXmlDeclaration* ToDeclaration() const {
		return MaybeCastToMoreDefinedType<const TiXmlDeclaration>(DECLARATION);
	}
